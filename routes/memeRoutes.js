...
const { generateTextMeme, shareMeme, getSharedMemes, voteOnMeme } = require("../controllers/memeController");

// POST /api/meme/text
router.post("/text", generateTextMeme);

// Community meme sharing endpoints
router.post('/share', shareMeme);
router.get('/', getSharedMemes);
router.post('/:id/vote', voteOnMeme);
